...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::NewProp_NumInputs_MetaData[] = {
		{ "ModuleRelativePath", "Public/Classes/K2Node_LowEntry_CreateByteDataWriter.h" },
		{ "ToolTip", "The number of input pins to generate for this node" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::NewProp_NumInputs = { UE4CodeGen_Private::EPropertyClass::Int, "NumInputs", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UK2Node_LowEntry_CreateByteDataWriter, NumInputs), METADATA_PARAMS(Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::NewProp_NumInputs_MetaData, ARRAY_COUNT(Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::NewProp_NumInputs_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::NewProp_NumInputs,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::ClassParams = {
		...
		0x000800A0u,
		nullptr, 0,
		Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriter_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UK2Node_LowEntry_CreateByteDataWriter, 3605346878);
