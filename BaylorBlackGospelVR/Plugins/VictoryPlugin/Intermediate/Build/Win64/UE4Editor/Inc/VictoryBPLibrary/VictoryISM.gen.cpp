...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AVictoryISM_Statics::NewProp_Mesh = { UE4CodeGen_Private::EPropertyClass::Object, "Mesh", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00100000000a001d, 1, nullptr, STRUCT_OFFSET(AVictoryISM, Mesh), Z_Construct_UClass_UInstancedStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AVictoryISM_Statics::NewProp_Mesh_MetaData, ARRAY_COUNT(Z_Construct_UClass_AVictoryISM_Statics::NewProp_Mesh_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AVictoryISM_Statics::ClassParams = {
		...
		0x008000A0u,
		nullptr, 0,
		Z_Construct_UClass_AVictoryISM_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AVictoryISM_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_AVictoryISM_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AVictoryISM_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AVictoryISM, 622889995);
